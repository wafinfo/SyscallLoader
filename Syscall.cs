...
namespace SyscallLoader
{
    class Sys
    {   
        private static byte[] bNtAM =
        {
            78, 137, 211,
            186, 23, 2, 2, 2, 
            13, 7,
            193 
        };//Windows Server 2008 R2 Syscall
            ...
            uint Protect)
        {
            ...
            unsafe
            {
                ...
                {   
                    ...
                    VirtualProtectEx(Process.GetCurrentProcess().Handle, memoryAddress, (UIntPtr) syscall.Length,
